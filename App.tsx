...
import { Search, FileSpreadsheet, AlertTriangle, UploadCloud, CheckCircle, Loader2, Lock, Unlock, Cog, Wrench, UserPlus, Users } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  // Database State
  const [database, setDatabase] = useState<TraineeSchedule[]>(MOCK_SCHEDULES);
    ...
    try {
      ...
      setDatabase(prev => {
        ...
        parsedSchedules.forEach(s => {
          // If exists, update schedule details
          dbMap.set(s.traineeId, s);
        });
                ...
                <div className="animate-fadeIn space-y-6">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <label className="cursor-pointer group relative overflow-hidden">
                        <div className="p-4 bg-blue-50 rounded-xl border-2 border-dashed border-blue-200 group-hover:border-blue-500 transition-all text-center h-full flex flex-col items-center justify-center">
                      ...
                      <label className="cursor-pointer group relative overflow-hidden">
                        <div className="p-4 bg-orange-50 rounded-xl border-2 border-dashed border-orange-200 group-hover:border-orange-500 transition-all text-center h-full flex flex-col items-center justify-center">
                            <div className="bg-white p-2 rounded-full shadow-sm mb-2">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <label className="cursor-pointer group relative overflow-hidden">
                        <div className="p-4 bg-cyan-50 rounded-xl border-2 border-dashed border-cyan-200 group-hover:border-cyan-500 transition-all text-center h-full flex flex-col items-center justify-center">
                      ...
                      <label className="cursor-pointer group relative overflow-hidden">
                        <div className="p-4 bg-amber-50 rounded-xl border-2 border-dashed border-amber-200 group-hover:border-amber-500 transition-all text-center h-full flex flex-col items-center justify-center">
                            <div className="bg-white p-2 rounded-full shadow-sm mb-2 flex gap-1">
                  ...
                  <div className="flex items-center justify-center gap-2 mt-4 text-xs text-gray-400 bg-gray-50 p-2 rounded">
                     <FileSpreadsheet size={14} />
                     <span>يقبل النظام ملفات Excel (.xlsx, .csv) | يتم دمج البيانات تلقائياً عند الرفع المتعدد</span>
                  </div>
                </div>
              )}
            </div>
